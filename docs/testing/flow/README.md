...
| 10 | [`10-redesain-dan-laporan.md`](./10-redesain-dan-laporan.md) | **Phase 8.6** — empat lebar (360/390/820/1440) tanpa guliran horizontal, kerangka HP (bilah bawah + Lainnya), daftar jadi kartu, dialog jadi sheet, **Laporan**: angka cocok dengan daftar lead, filter, tooltip lewat keyboard, keadaan kosong/sedikit/gagal; §10.6 cek mobile di HP fisik (bersama `07`) |
