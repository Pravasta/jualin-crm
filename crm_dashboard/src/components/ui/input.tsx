...
// Phone widths (Phase 8.6, #161): 44px tall — the touch-target floor in
// design brief §9.2 — and 16px text, below which iOS Safari zooms the page
// on focus. From 768px up it is shadcn's compact 32px / 14px.
